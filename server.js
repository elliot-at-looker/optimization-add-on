...
function analyzeJobDescription(jobDescriptionWordFreqObj) {
  ...
  var selectStmt = `SELECT * FROM word_freq.word_freq WHERE word in (${jobDescriptionWordFreqStr});`
